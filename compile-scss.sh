...
sass scss/bootstrap/_theme.scss dist/css/bootstrap.theme.css
echo "Compiling Bracketstrap - Theme Minimal"
sass scss/bootstrap/_theme.scss dist/css/bootstrap.theme.min.css --style=compressed
